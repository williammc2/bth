...
export default function Register(){
    ...
    //Async usamos para utilizar o metodo await
    async function handleRegister(e){
        ...
        try {
        //o axios ja envia no formato JSON
        ...
        <div className="register-container">
            <div className="content">
                ...
                <form onSubmit={handleRegister}>
                    ...
                    <input value={name} onChange={e => setName(e.target.value)} placeholder="Nome da ONG"></input>
